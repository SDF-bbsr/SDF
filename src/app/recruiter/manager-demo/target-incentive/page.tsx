// src/app/recruiter/manager-demo/target-incentive/page.tsx
"use client";
    ...
    const handleSaveTargets = async () => {
        ...
        setTimeout(() => {
            ...
            sonnerToast.info("This is a demo environment.", {
                description: "Saving targets and incentives is disabled. In a real application, this would update the database with the new values.",
            });
