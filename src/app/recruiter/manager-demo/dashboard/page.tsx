  ...
  return (
      <Card className="border-dashed">
          <CardHeader>
              ...
              <p className="text-sm text-slate-800 pt-1">No sales insight has been generated for today yet.</p>
          </CardHeader>
      </Card>
  );
}
      ...
      <button className="w-full flex justify-between items-center text-left p-4" onClick={onToggle}>
          <div className="flex items-center gap-3">
              ...
              <div>
                  ...
                  <p className="text-xs text-slate-800 mt-1">Last generated: {formatLastUpdated(insight.lastUpdated)}</p>
              </div>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-6">
              <div className="p-4 rounded-lg bg-background/50">
                ...
                <p className="text-sm text-slate-800 mt-2 italic">"{insight.salesForecast.reasoning}"</p>
              </div>
              <div className="p-4 rounded-lg bg-background/50">
                <h3 className="font-semibold flex items-center gap-2 mb-2"><BookOpenText className="h-5 w-5 text-primary" /> Analysis</h3>
                <p className="text-sm text-slate-800">{insight.analysis}</p>
              </div>
            </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Total Sales Today <p className="text-xl font-bold">[{Store_Name}]</p></CardTitle>
            ...
            <CardContent>
              ...
              {weeklyPacing && weeklyPacing.isTargetConfigured ? (
                ...
                <p className="text-xs text-slate-800 mt-1">Weekly target not set for current period.</p>
              )}
            </CardContent>
          </Card>
          ...
          <Card className="md:col-span-2 lg:col-span-2 xl:col-span-2">
            ...
            <CardContent className="max-h-60 p-0">
               ...
               ) : <p className="text-sm text-slate-800 py-4 text-center h-full flex items-center justify-center">No sales by staff today.</p>}
            </CardContent>
          </Card>
        </div>
      </section>
        ...
        <div>
          ...
          <Card>
            <CardContent className="pt-6 h-72 sm:h-80">
              ...
              ) : <p className="text-sm text-slate-800 h-full flex items-center justify-center">Not enough data for sales trend.</p>}
            </CardContent>
          </Card>
        </div>
        ...
        <div>
          ...
          <Card>
            <CardContent className="pt-6 h-72 sm:h-80">
              ...
              ) : <p className="text-sm text-slate-800 h-full flex items-center justify-center">No sales data by hour for today yet.</p>}
            </CardContent>
          </Card>
        </div>
      </section>
       ...
       <section className="mt-6">
        ...
        <Card>
          <CardContent className="pt-0">
            ...
            ): <p className="text-sm text-slate-800 py-4 text-center">No items sold today yet.</p>}
          </CardContent>
        </Card>
      </section>
    </>
